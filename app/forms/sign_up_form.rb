class SignUpForm < ApplicationForm
  form do |sign_up_form|
    ...
    sign_up_form.text_field(name: :school_code, label: "School Code", required: true, placeholder: "Enter your school referral code", maxlength: 4, scope_name_to_model: false, value: @school_code || "1234")
